...
'''Configure AppKey'''
APP_KEY = '563864621'
APP_SECRET = '9404dfe6f09bcdd22d409b2cdd77dcb7'
CALLBACK_URL = 'http://apps.weibo.com/rhgjhgjtmtt'
client = APIClient(app_key = APP_KEY, app_secret = APP_SECRET, redirect_uri = CALLBACK_URL)
access_token = "2.006g_eBD0fwuJc2349e9d469olilPB"
expires_in = "1554268769"
...
for i in range(1200,1400):        #consider 150 per account 1000 per ip,we can use 6 scripts and accounts
    ...
    while (k<41)&(j>0):
        try:
            ...
            traceback.print_exc()
            logger.warning('api query error:3')
            time.sleep(3600)
        else:
            j=j-50
