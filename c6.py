...
def total_number(mid):
    try:
        ...
        traceback.print_exc()
        logger.warning('api query error:6')
        time.sleep(3660)
...
for i in range(9134,9513):        #consider 150 per account 1000 per ip,we can use 6 scripts and accounts
