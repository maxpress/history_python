...
'''Configure AppKey'''
APP_KEY = '562277097'
APP_SECRET = 'e0510619c6f0f374dfe2d25459482082'
CALLBACK_URL = 'http://apps.weibo.com/dfsdfdsdf'
client = APIClient(app_key = APP_KEY, app_secret = APP_SECRET, redirect_uri = CALLBACK_URL)
access_token = "2.00HFVP9C08xPDc3c442d9d914vu3fB"
expires_in = "1557064790"
...
for i in range(1100,1200):        #consider 150 per account 1000 per ip,we can use 6 scripts and accounts
    ...
    while (k<41)&(j>0):
        try:
            ...
            traceback.print_exc()
            logger.warning('api query error:1')
            time.sleep(3600)
        else:
            j=j-50
