...
'''Configure AppKey'''
APP_KEY = '4022514222'
APP_SECRET = 'f25805d3cc8297958dee436b2c275cc6'
CALLBACK_URL = 'http://apps.weibo.com/lkkjkjkedgd'
client = APIClient(app_key = APP_KEY, app_secret = APP_SECRET, redirect_uri = CALLBACK_URL)
access_token = "2.006g_eBDehDO5Ea530ac83530p3u1l"
expires_in = "1554268460"
...
for i in range(3162,3200):        #consider 150 per account 1000 per ip,we can use 6 scripts and accounts
    ...
    while (k<41)&(j>0):
        try:
            ...
            traceback.print_exc()
            logger.warning('api query error:2')
            time.sleep(3600)
        else:
            j=j-50
